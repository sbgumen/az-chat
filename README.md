...
<div align="center">
  <img src="screenshots/01.jpg" width="24%" alt="截图1" />
  <img src="screenshots/02.jpg" width="24%" alt="截图2" />
  <img src="screenshots/03.jpg" width="24%" alt="截图3" />
  <img src="screenshots/04.jpg" width="24%" alt="截图4" />
</div>
...
AZ-Chat 开源的核心理念是 **「以开源验证需求，以商业持续发展」**。

**1. 验证市场需求**

一个好的产品不是闭门造出来的。通过开源，让真实用户来使用、反馈、吐槽，我们才能知道市场真正需要什么，什么功能是刚需，什么体验还有不足。

**2. 收集用户反馈驱动迭代**

一个人的想法有限。开源后，每位用户的使用反馈和功能建议，都是产品进化的方向。你的每一个 Issue 都在帮助 AZ-Chat 变得更好。

**3. 降低用户信任门槛**

源码开放，你可以审查每一行代码——有没有后门、数据怎么存储、安全怎么做的，一目了然。比闭源 SaaS 更透明，比大厂 IM 更自主。

**4. 建立开发者社区**

开源是发现同路人最好的方式。无论是贡献代码的开发者，还是深度使用的用户，社区的智慧远比一个人埋头苦干有效率。

### 关于商业化

AZ-Chat 当前版本 **完全免费开源**，但未来计划推出付费进阶版本：

| 类型 | 说明 |
|------|------|
| **开源版（当前）** | 永久免费，社区支持，包含核心通讯功能 |
| **进阶版（规划中）** | 付费授权，提供高级功能（AI 助手、数据大屏、高级权限管理、专属技术支持等） |

> 💡 **对开源版用户的承诺**：当前所有功能永久免费，不会转为收费。进阶版是在现有功能基础上的增值扩展，不影响开源版的正常使用。
